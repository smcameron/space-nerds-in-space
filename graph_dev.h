...
extern void graph_dev_start_frame(int wn);
extern void graph_dev_end_frame(int wn);
extern void graph_dev_set_context(void *gdk_drawable, void *gdk_gc);
extern void graph_dev_set_color(int wn, void *gdk_color, float a);
extern void graph_dev_set_screen_size(int wn, int width, int height);
extern void graph_dev_set_extent_scale(int wn, float x_scale, float y_scale);
extern void graph_dev_set_3d_viewport(int wn, int x_offset, int y_offset, int width, int height);
...
extern void graph_dev_draw_entity(int wn, struct entity_context *cx, struct entity *e, union vec3 *eye_light_pos,
	const struct entity_transform *transform);
extern void graph_dev_draw_3d_line(int wn, struct entity_context *cx, const struct mat44 *mat_vp,
		const struct mat44 *mat_v, float x1, float y1, float z1, float x2, float y2, float z2);

extern void graph_dev_draw_line(int wn, float x1, float y1, float x2, float y2);
extern void graph_dev_draw_rectangle(int wn, int filled, float x, float y, float width, float height);
extern void graph_dev_draw_point(int wn, float x, float y);
extern void graph_dev_draw_arc(int wn, int filled, float x, float y, float width, float height,
...
extern void graph_dev_draw_skybox(int wn, struct entity_context *cx, const struct mat44 *mat_vp);
...
extern void graph_dev_grab_framebuffer(int wn, unsigned char **buffer, int *width, int *height);
