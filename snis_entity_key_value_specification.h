...
struct key_value_specification snis_entity_kvs[] = {
	...
	UINT8_TSDFIELD(power_data.maneuvering.p[0]),
	UINT8_TSDFIELD(power_data.maneuvering.p[1]),
	UINT8_TSDFIELD(power_data.maneuvering.p[2]),
	UINT8_TSDFIELD(power_data.maneuvering.p[3]),
	UINT8_TSDFIELD(power_data.maneuvering.p[4]),
	UINT8_TSDFIELD(power_data.maneuvering.p[5]),
	...
	UINT8_TSDFIELD(power_data.warp.p[0]),
	UINT8_TSDFIELD(power_data.warp.p[1]),
	UINT8_TSDFIELD(power_data.warp.p[2]),
	UINT8_TSDFIELD(power_data.warp.p[3]),
	UINT8_TSDFIELD(power_data.warp.p[4]),
	UINT8_TSDFIELD(power_data.warp.p[5]),
	...
	UINT8_TSDFIELD(power_data.impulse.p[0]),
	UINT8_TSDFIELD(power_data.impulse.p[1]),
	UINT8_TSDFIELD(power_data.impulse.p[2]),
	UINT8_TSDFIELD(power_data.impulse.p[3]),
	UINT8_TSDFIELD(power_data.impulse.p[4]),
	UINT8_TSDFIELD(power_data.impulse.p[5]),
	...
	UINT8_TSDFIELD(power_data.sensors.p[0]),
	UINT8_TSDFIELD(power_data.sensors.p[1]),
	UINT8_TSDFIELD(power_data.sensors.p[2]),
	UINT8_TSDFIELD(power_data.sensors.p[3]),
	UINT8_TSDFIELD(power_data.sensors.p[4]),
	UINT8_TSDFIELD(power_data.sensors.p[5]),
	...
	UINT8_TSDFIELD(power_data.comms.p[0]),
	UINT8_TSDFIELD(power_data.comms.p[1]),
	UINT8_TSDFIELD(power_data.comms.p[2]),
	UINT8_TSDFIELD(power_data.comms.p[3]),
	UINT8_TSDFIELD(power_data.comms.p[4]),
	UINT8_TSDFIELD(power_data.comms.p[5]),
	...
	UINT8_TSDFIELD(power_data.phasers.p[0]),
	UINT8_TSDFIELD(power_data.phasers.p[1]),
	UINT8_TSDFIELD(power_data.phasers.p[2]),
	UINT8_TSDFIELD(power_data.phasers.p[3]),
	UINT8_TSDFIELD(power_data.phasers.p[4]),
	UINT8_TSDFIELD(power_data.phasers.p[5]),
	...
	UINT8_TSDFIELD(power_data.shields.p[0]),
	UINT8_TSDFIELD(power_data.shields.p[1]),
	UINT8_TSDFIELD(power_data.shields.p[2]),
	UINT8_TSDFIELD(power_data.shields.p[3]),
	UINT8_TSDFIELD(power_data.shields.p[4]),
	UINT8_TSDFIELD(power_data.shields.p[5]),
	...
	UINT8_TSDFIELD(power_data.tractor.p[0]),
	UINT8_TSDFIELD(power_data.tractor.p[1]),
	UINT8_TSDFIELD(power_data.tractor.p[2]),
	UINT8_TSDFIELD(power_data.tractor.p[3]),
	UINT8_TSDFIELD(power_data.tractor.p[4]),
	UINT8_TSDFIELD(power_data.tractor.p[5]),
	...
	UINT8_TSDFIELD(power_data.lifesupport.p[0]),
	UINT8_TSDFIELD(power_data.lifesupport.p[1]),
	UINT8_TSDFIELD(power_data.lifesupport.p[2]),
	UINT8_TSDFIELD(power_data.lifesupport.p[3]),
	UINT8_TSDFIELD(power_data.lifesupport.p[4]),
	UINT8_TSDFIELD(power_data.lifesupport.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.maneuvering.p[0]),
	UINT8_TSDFIELD(coolant_data.maneuvering.p[1]),
	UINT8_TSDFIELD(coolant_data.maneuvering.p[2]),
	UINT8_TSDFIELD(coolant_data.maneuvering.p[3]),
	UINT8_TSDFIELD(coolant_data.maneuvering.p[4]),
	UINT8_TSDFIELD(coolant_data.maneuvering.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.warp.p[0]),
	UINT8_TSDFIELD(coolant_data.warp.p[1]),
	UINT8_TSDFIELD(coolant_data.warp.p[2]),
	UINT8_TSDFIELD(coolant_data.warp.p[3]),
	UINT8_TSDFIELD(coolant_data.warp.p[4]),
	UINT8_TSDFIELD(coolant_data.warp.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.impulse.p[0]),
	UINT8_TSDFIELD(coolant_data.impulse.p[1]),
	UINT8_TSDFIELD(coolant_data.impulse.p[2]),
	UINT8_TSDFIELD(coolant_data.impulse.p[3]),
	UINT8_TSDFIELD(coolant_data.impulse.p[4]),
	UINT8_TSDFIELD(coolant_data.impulse.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.sensors.p[0]),
	UINT8_TSDFIELD(coolant_data.sensors.p[1]),
	UINT8_TSDFIELD(coolant_data.sensors.p[2]),
	UINT8_TSDFIELD(coolant_data.sensors.p[3]),
	UINT8_TSDFIELD(coolant_data.sensors.p[4]),
	UINT8_TSDFIELD(coolant_data.sensors.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.comms.p[0]),
	UINT8_TSDFIELD(coolant_data.comms.p[1]),
	UINT8_TSDFIELD(coolant_data.comms.p[2]),
	UINT8_TSDFIELD(coolant_data.comms.p[3]),
	UINT8_TSDFIELD(coolant_data.comms.p[4]),
	UINT8_TSDFIELD(coolant_data.comms.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.phasers.p[0]),
	UINT8_TSDFIELD(coolant_data.phasers.p[1]),
	UINT8_TSDFIELD(coolant_data.phasers.p[2]),
	UINT8_TSDFIELD(coolant_data.phasers.p[3]),
	UINT8_TSDFIELD(coolant_data.phasers.p[4]),
	UINT8_TSDFIELD(coolant_data.phasers.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.shields.p[0]),
	UINT8_TSDFIELD(coolant_data.shields.p[1]),
	UINT8_TSDFIELD(coolant_data.shields.p[2]),
	UINT8_TSDFIELD(coolant_data.shields.p[3]),
	UINT8_TSDFIELD(coolant_data.shields.p[4]),
	UINT8_TSDFIELD(coolant_data.shields.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.tractor.p[0]),
	UINT8_TSDFIELD(coolant_data.tractor.p[1]),
	UINT8_TSDFIELD(coolant_data.tractor.p[2]),
	UINT8_TSDFIELD(coolant_data.tractor.p[3]),
	UINT8_TSDFIELD(coolant_data.tractor.p[4]),
	UINT8_TSDFIELD(coolant_data.tractor.p[5]),
	...
	UINT8_TSDFIELD(coolant_data.lifesupport.p[0]),
	UINT8_TSDFIELD(coolant_data.lifesupport.p[1]),
	UINT8_TSDFIELD(coolant_data.lifesupport.p[2]),
	UINT8_TSDFIELD(coolant_data.lifesupport.p[3]),
	UINT8_TSDFIELD(coolant_data.lifesupport.p[4]),
	UINT8_TSDFIELD(coolant_data.lifesupport.p[5]),
