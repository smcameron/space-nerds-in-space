...
GLOBAL void ui_element_list_draw(struct ui_element_list *list, int current_displaymode);
GLOBAL void ui_element_list_maybe_draw_tooltips(struct ui_element_list *list,
						int mousex, int mousey, int current_displaymode);
GLOBAL void ui_element_list_button_release(struct ui_element_list *list, int x, int y, int current_displaymode);
GLOBAL void ui_element_list_button_press(struct ui_element_list *list, int x, int y, int current_displaymode);
...
GLOBAL int ui_element_list_keypress(struct ui_element_list *list, SDL_Event *event, int current_displaymode);
GLOBAL int ui_element_list_keyrelease(struct ui_element_list *list, SDL_Event *event, int current_displaymode);
GLOBAL int ui_element_list_event(struct ui_element_list *list, SDL_Event *event, int current_displaymode);
