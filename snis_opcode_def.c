...
int snis_opcode_def_init(void)
{
	...
	rc |= init_opcode_def(OPCODE_UPDATE_SHIP, "bwwhSSSRRRwRRbbbwwbbbbbbbbbbbbwQQQQSSSbB8bbbwwbSS");
	...
	rc |= init_opcode_def(OPCODE_UPDATE_CITY, "bwwwSSSSSSQhhhb");
	...
	rc |= init_opcode_def(OPCODE_UPDATE_CARGO_CONTAINER, "bwwSSSwSbbbbb");
