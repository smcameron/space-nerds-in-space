...
_COMMONOBJS=mathutils.o snis_alloc.o snis_socket_io.o snis_marshal.o \
		...
		planetary_properties.o open-simplex-noise.o snis_licenses.o net_utils.o
...
MYCFLAGS=-DDESTDIR=${DESTDIR} -DPREFIX=${PREFIX} ${DEBUGFLAG} ${PROFILEFLAG} \
	${OPTIMIZEFLAG} ${ASANFLAG} ${UBSANFLAG} ${SPACEDUST} ${MOVING_STARFIELD}\
...
$(OD)/net_utils.o:	net_utils.c net_utils.h Makefile ${ODT}
	$(Q)$(COMPILE)
...
${OD}/infinite-taunt.o:	infinite-taunt.c infinite-taunt.h Makefile ${ODT}
	$(Q)$(COMPILE)

bin/infinite-taunt:	${OD}/infinite-taunt.o ${OD}/names.o ${OD}/mtwist.o ${OD}/string-utils.o ${OD}/stacktrace.o Makefile ${BIN}
	$(CC) -DTEST_TAUNT -o bin/infinite-taunt ${MYCFLAGS} ${OD}/mtwist.o infinite-taunt.c \
			${OD}/names.o ${OD}/string-utils.o ${OD}/stacktrace.o
...
bin/test-mathutils:	mathutils.c mathutils.h Makefile ${BIN} ${OD}/mtwist.o
	$(CC) ${MYCFLAGS} -DTEST_MATHUTILS -o bin/test-mathutils mathutils.c ${OD}/mtwist.o -lm
...
fuzz_read_starbase_metadata:	fuzz_read_starbase_metadata.c
...
run-fuzz-snis-read-ship-types:	fuzz_snis_read_ship_types put-cpu-in-hi-performance-mode
	/bin/rm -fr fuzz.out
...
run-fuzz-read-thrust-attachments:	fuzz_read_thrust_attachments put-cpu-in-hi-performance-mode
	/bin/rm -fr fuzz.out
...
run-fuzz-read-starbase-metadata:	fuzz_read_starbase_metadata put-cpu-in-hi-performance-mode
	/bin/rm -fr fuzz.out
