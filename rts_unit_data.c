...
static struct rts_order_data order_data[] = {
	...
	{ "ATTACK NEAREST ENEMY", "ORDER UNIT TO ATTACK NEAREST ENEMY UNITS", 500.0, },
	{ "MOVE TO WAYPOINT", "ORDER UNIT TO MOVE TO THE SPECIFIED WAYPOINT", 200.0, },
	{ "OCCUPY NEAREST BASE", "ORDER UNIT TO MOVE TO AND OCCUPY THE NEAREST UNOCCUPIED STARBASE", 200.0, },
	{ "ATTACK ENEMY PLANET", "ORDER UNIT TO ATTACK THE ENEMY HOME PLANET", 300.0, },
};
