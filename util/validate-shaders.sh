...
validate_es_vs "share/snis/shader-es/sun.vert"
validate_es_fs "share/snis/shader-es/sun.frag"
...
validate_gl_vs "share/snis/shader/sun.vert"
validate_gl_fs "share/snis/shader/sun.frag"
