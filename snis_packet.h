...
#define DISPLAYMODE_FONTTEST 7
#define DISPLAYMODE_INTROSCREEN 8
#define DISPLAYMODE_LOBBYSCREEN 9
#define DISPLAYMODE_CONNECTING 10 
#define DISPLAYMODE_CONNECTED 11 
#define DISPLAYMODE_FINDSERVER 12 
